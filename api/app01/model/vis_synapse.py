...
def prediction(gt_file, pred_file,slice_idx,save_file):
    ...
    # Define organ labels and corresponding colors for Synapse dataset
    organ_labels = {
        1: "Aorta",
        2: "Gallbladder",
        3: "Left Kidney",
    ...
    # Add color legend with smaller font size and adjusted position
    ...
    ax.legend(handles=legend_elements, loc="upper left", bbox_to_anchor=(1.05, 1), title="Organs", fontsize='small', title_fontsize='small')
